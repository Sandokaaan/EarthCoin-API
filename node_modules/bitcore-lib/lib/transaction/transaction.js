...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  if (this.version > 1) {
//    console.log('write comment to tx: ');
    if (this.txComment) {
      writer.writeUInt8(this.txComment.length);
      writer.write(this.txComment);
//      console.log('zapsano ', this.txComment.length);
    }
    else
      writer.writeUInt8(0);
  }
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if (this.version > 1) {
    var txCommentSize = reader.readUInt8();   // possibly Varint, but limited to 140 byted so always should be max 1 byte
//console.log('tx comment size: ', txCommentSize);
    if (txCommentSize !=0) {
      var txComment = reader.read(txCommentSize);
      this.txComment = txComment;
//console.log('tx_comment: ', txComment.toString());
    }
  }
